...
<div id="arm-about-panel" class="arm-panel" role="complementary" aria-label="About this atlas">
  <div class="arm-body">
    ...
    <p class="arm-p">A live semantic map of recent AI research from arXiv (cs.AI), rebuilt every day across a rolling """ + str(RETENTION_DAYS) + """-day window. Each point is a paper. Groups are determined by Gemini 2.5 Flash-Lite based on shared research methodology and problem formulation.</p>
...
<div id="arm-about-panel" class="arm-panel" role="complementary" aria-label="About this atlas">
  <div class="arm-body">
    ...
    <p class="arm-p">A live semantic map of recent AI research from arXiv (cs.AI), rebuilt every day across a rolling 14-day window. Each point is a paper. Groups are determined by Gemini 2.5 Flash-Lite based on shared research methodology and problem formulation.</p>
    <p class="arm-p"><a href="https://github.com/LeeFischman/AI-research-atlas" target="_blank" rel="noopener">More...</a></p>
